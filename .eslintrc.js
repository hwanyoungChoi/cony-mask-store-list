/**
 * 라인 뒤에 HIDDENTRACK 주석이 붙어있는 RULE은 검토된 것임
 * 그 외에 것은 react boilerplate 기본값들
 */
...
module.exports = {
  ...
  overrides: [
      {
          files: ['*.js'],
          excludedFiles: ["eslint/*.js", "index.js"],
          parser: 'babel-eslint',
          plugins: ['flowtype'],
          rules: {
              // Flow Plugin
  ...
  rules: {
      ...
      'eslint-comments/no-unused-disable': 0, // HIDDENTRACK
      ...
      'react/jsx-tag-spacing': ['warn', { // HIDDENTRACK
          closingSlash: 'never',
      ...
      /**
       * Custom hook을 위해 이 코드를 수정하여 직접 개발한 custom lint rule을 사용
       */
      ...
      'react-native/no-inline-styles': 'off', // HIDDENTRACK
